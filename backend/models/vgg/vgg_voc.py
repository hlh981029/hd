...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=1000, init_weights=True, bp_type='BP'):
    ...
    # backward for guided backpropagation
    def _override_backward(self):
        ...
        self.features.apply(replace)
        self.classifier1.apply(replace)
