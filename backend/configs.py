root_dir = './'
data_root = './../OAA/data/VOCdevkit/VOC2012/'
save_dir = data_root + 'hcrm/vis_2007_000170_noenhanced_0/'
img_dir = data_root + 'JPEGImages/'
train_list = data_root + 'ImageSets/Segmentation/train_cls.txt'
test_list = data_root + 'ImageSets/Segmentation/train_cls.txt'
batch_size = 1
input_size = 224
crop_size = 224
...
pattern_dir = root_dir + 'static/pattern/'
sample_dir = root_dir + 'static/sample/'
top_n = 9
atten_thres_all = 0.5
...
num_classes = 20
dataset = 'pascal_voc'
restore_from = root_dir + 'snapshots/pascal_voc_epoch_14.pth'
class_label = ['Aeroplane', 'Bicycle', 'Bird', 'Boat',
  'Bottle', 'Bus', 'Car', 'Cat',
...
# num_classes = 1000
# dataset = 'imagenet'
# restore_from = root_dir + 'snapshots/vgg16-397923af.pth'
# class_label = [
...
#   'Loafer', 'lotion', 'loudspeaker', 'loupe', 'lumbermill', 'magnetic_compass', 'mailbag', 'mailbox', 'maillot', 'maillot',
